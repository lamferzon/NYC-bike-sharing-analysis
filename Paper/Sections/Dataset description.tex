...
\begin{table}[h!]
	...
	\begin{tabular}{c|c|c|c|c|c|c|c}
		...
		\hline
		\textbf{avg. pickups} & 0.06 & 58.27 & 18.04 & 17.32 & 10.24 & 0.88 & 4.35  \\
		\hline
		\textbf{avg.trip duration} & 6.60 & 387.21 & 26.76 & 21.30 & 28.92 & 7.08 & 75.13  \\
		\hline
		\textbf{distance} & 0.05 & 1.29 & 0.49 & 0.35 & 0.36 & 0.89 & 2.65  \\
		\hline
	\end{tabular}
	\caption{main statistics concerning Bike sharing variables.}
