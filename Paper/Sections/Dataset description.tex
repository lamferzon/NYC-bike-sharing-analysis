...
\begin{figure}[h!]
	\centering
	\subfigure[]{\label{Trend}\includegraphics[height=155px]{Images/Dataset description/Chosen/Trend}}\quad
	\subfigure[]{\label{Map}\includegraphics[height=155px]{Images/Dataset description/Chosen/Map}}\quad
...
\begin{figure}[h!]
	\centering
	\subfigure[]{\label{T_plot_box}\includegraphics[height=155px]{Images/Dataset description/Chosen/Mean_feels_like_temperature_plot}}\quad
	\subfigure[]{\label{Rain_plot_box}\includegraphics[height=155px]{Images/Dataset description/Chosen/Rainfall_plot}}\quad
	\subfigure[]{\label{Ty_box}\includegraphics[height=155px]{Images/Dataset description/Chosen/Mean_feels_like_temperature_box}}\quad
	\subfigure[]{\label{Rain_box}\includegraphics[height=155px]{Images/Dataset description/Chosen/Rainfall_box}}\quad
	\subfigure[]{\label{Cloud_box}\includegraphics[height=155px]{Images/Dataset description/Chosen/Cloud_cover_box}}\quad
	\subfigure[]{\label{UV_box}\includegraphics[height=155px]{Images/Dataset description/Chosen/UV_index_box}}\quad
